...
public class SongServiceImpl implements SongService {
    ...
    @Override
    public List<SongResponseType> getTop10SongsPopular() {
        List<Songs> list10BestSongs = songRepository.getTop10SongPopular();
        List<SongResponseType> songResponseTypes = list10BestSongs.stream().map(songs -> songConverter.convertToDTO(songs)).collect(Collectors.toList());
